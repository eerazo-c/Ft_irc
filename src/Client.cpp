...
//isra funtions
std::string& Client::getSendBuff(){ return this->sendBuff;}
void Client::sendingBuff(const std::string& msg){ this->sendBuff += msg;}
void Client::clearSendingBugg(){ this->sendBuff.clear();}